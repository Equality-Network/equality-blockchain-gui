...
import { AlertDialog, Flex, Card } from '@equality/core';
...
import { mojo_to_equality_string, equality_to_mojo } from '../../../util/equality';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_equality_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of equality in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Equality that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Equality that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = equality_to_mojo(amount_input.value);
    const fee = equality_to_mojo(fee_input.value);
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send equality to coloured address. Please enter a equality
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'equality_addr://') {
