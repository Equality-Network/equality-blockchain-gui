...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@equality/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Equality-Network/equality-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
