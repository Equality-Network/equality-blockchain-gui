...
import { CardHero, Link } from '@equality/core';
import { PlotHero as PlotHeroIcon } from '@equality/icons';
      ...
      <Grid xs={12} md={6} lg={4} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {'Plots are allocated space on your hard drive used to farm and earn Equality. '}
              <Link target="_blank" href="https://github.com/Equality-Network/equality-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
