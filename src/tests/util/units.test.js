...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of equality", () => {
      const result = units.getUnit("equality");
    ...
    it("gets unit of equality using alias", () => {
  ...
  describe("#getDisplay", () => {
    it("gets display of equality", () => {
      const result = units.getDisplay("equality");
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("equality", 9);

      const result = units.getUnit("equality");

      expect(result).toEqual(9);

      units.setUnit("equality", 1);
    });
  });
  describe("#setDisplay", () => {
